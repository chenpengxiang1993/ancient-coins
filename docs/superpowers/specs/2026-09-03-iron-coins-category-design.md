...
>
> **修订 v4（用户 2026-09-03，纪年纪监逐年拆行指令）**："不不不，背一、背二、背三、背汉二、背春二这种需要拆分版别，不能组合为一个版别"（承接"貌似还缺少一些铸造局和纪年的组合，例如绍熙元宝背汉二"）。v3 的"面值×监"系列行（描述中逐年列举）不满足要求——**每一个监年组合/纪年数字都必须是一独立版别行**。执行口径：
> 1. **纯纪年逐年拆行**：淳熙元宝小平背"七"至"十六"、淳熙通宝折二背"七"至"十六"各 10 行；绍熙元宝/通宝小平背"元"至"五"各 5 行；嘉泰通宝折二背"元"至"四" 4 行（"四"字行注"一说铸止于三年"两说并存）；开禧通宝折二背"元"至"三" 3 行；嘉定通宝小平/折二背"元"至"十七"各 17 行；嘉定元宝折二背"元"至"十七" 17 行；
> 2. **监年合书逐年拆行**：绍熙元宝折二背"春元"至"春五"、"同元"至"同五"、"汉元"至"汉五"各 5 行（汉二行注普品成交约 180 元），另背"光二"（光州监，今河南潢川）1 行；绍熙通宝折二背"春元"至"春五"、"汉元"至"汉五"各 5 行；庆元通宝小平背"春元"至"春七"/"同元"至"同七"/"汉元"至"汉五"、折二背"春元"至"春七"/"同元"至"同七"/"汉元"至"汉七"共 40 行（订正：折二春系至"春七"、汉系至"汉七"，逾旧录"春六""汉五"之限，搜狐全文核实；"七"字钱六级稀，普品约 300 元）；嘉泰通宝折二背"春元"至"春四"、"同元"至"同四"、"汉元"至"汉四"各 4 行；开禧通宝小平背"春元"至"春三"、"同元"至"同三"各 3 行（网易《宋朝钱币大全》）；嘉定通宝折二背"春元"至"春五"及"春十三" 6 行（聚宝贝图录）、小平背"同元"至"同七" 7 行（《古泉汇》"自元至七全"，同三注上博藏品+戴醇士试范钱）；
> 3. **庆元元宝订正**：原"折二背纪年（元至六）"有误——庆元元宝仅见折三铁钱、皆背"川"（巩州惠民监，今甘肃陇西），孙仲汇考"卅四"等为庆元二年至三年间炉次，拆为背"川卅四"/"川卅五"/"川三六"/"川卅七"/"川六卅七" 5 行+铜品铁母背"川卅七"（径 32.45mm，极罕）；
> 4. **每行独立五要素**：每行自载径/重、面文读法、监造局今地、铸造公元年、与邻行区分句；绍熙通宝折五试铸背"四"单列（因光宗退位未及流通，四级珍罕）；
> 5. **宁缺毋滥边界（保留系列行）**：淳熙"汉""安"系、嘉定折二"汉"系逐年谱录不全，保留系列行并明注"谱录不全，不逐年分列"；
> 6. **配套**：`variant-standard.json` "20" 十币关键词重写为逐行粒度（如"小平背春元"…"折二背汉七"，双向子串无冲突）；版别行 181 → **351 行**；`audit-variant-completeness` 缺失 0/待复核 0、`audit-variant-quality` 弱描述 0、`validate` 通过、`tsc`/`build` 通过、0–19.json 零改动。
